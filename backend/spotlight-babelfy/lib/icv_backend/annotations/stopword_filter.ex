defmodule ICVBackend.Annotations.StopwordFilter do
  ...
  def remove_buckets(buckets) do
    # IO.inspect(buckets)

    Enum.map(buckets, fn bucket ->
      Task.async(fn ->
        if is_stopword?(bucket.text) do
          false
        else
          bucket
        end
